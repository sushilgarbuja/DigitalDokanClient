...
import { handleProductDelete, type IProductAdmin } from "../../../../store/adminProductSlice"
                    ...
                    <div className="min-w-full inline-block align-middle">
                        <div className="relative  text-gray-500 focus-within:text-gray-900 mb-4">
                            ...
                            <div className="flex justify-between">
                                <input type="text" id="default-search" className="block w-80 h-11 pr-5 pl-12 py-2.5 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-full placeholder-gray-400 focus:outline-none" placeholder="Search Product" onChange={(e) => setSearchTerm(e.target.value)} />
                                <button className="p-2 rounded group transition-all duration-500  flex item-center bg-blue-600 text-white" onClick={openModal}>+Product</button>
                            </div>
                        </div>
                            ...
                            <table className=" min-w-full rounded-xl">
                                <thead>
                                    <tr className="bg-gray-50">
                                        ...
                                        <th scope="col" className="p-5 text-left text-sm leading-6 font-semibold text-gray-900 capitalize"> Product Stock </th>
                                        <th scope="col" className="p-5 text-left text-sm leading-6 font-semibold text-gray-900 capitalize"> Product Price </th>
                                        ...
                                        filteredProducts.length > 0 && filteredProducts.map((product) => {
                                            ...
                                            return (
                                                <tr key={product?.id} className="bg-white transition-all duration-500 hover:bg-gray-50">
                                                    <Link to={`/product/${product?.id}`}><td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> {product.id}</td></Link>
                                                    ...
                                                    <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> {product?.createdAt}</td>
                                                    <td className=" p-5 ">
                                                        <div className="flex items-center gap-1">
                                                            ...
                                                            <button onClick={() => deleteProduct(product.id)} className="p-2 rounded-full  group transition-all duration-500  flex item-center">
