    ...
    const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            dispatch(addProduct(data)).then(() => {
                closeModal(); // Close the modal after product is added successfully
