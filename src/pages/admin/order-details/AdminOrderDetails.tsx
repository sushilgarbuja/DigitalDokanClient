...
import { fetchMAdminOrderDetails } from "../../../store/adminOrderSlice"
...
function AdminOrderDetails() {
    ...
    useEffect(() => {
        if (id) {
            dispatch(fetchMAdminOrderDetails(id))
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800 w-full xl:w-96 flex justify-between items-center md:items-start px-4 py-6 md:p-6 xl:p-8 flex-col">
                        ...
                        <div className="flex flex-col md:flex-row xl:flex-col justify-start items-stretch h-full w-full md:space-x-6 lg:space-x-8 xl:space-x-0">
                            ...
                            <div className="flex justify-between xl:h-full items-stretch w-full flex-col mt-6 md:mt-0">
                                ...
                                <label htmlFor="" className="text-base dark:text-white font-semibold leading-4 text-gray-800">Change Payment Status </label>
                                <select name="" id="" className="text-sm dark:text-gray-300 leading-5 text-gray-600">
                                ...
                                <div className="flex w-full justify-center items-center md:justify-start md:items-start">
                                    {
                                        orderDetails[0]?.order?.orderStatus !== OrderStatus?.Cancelled && (
                                            <>
                                                <label htmlFor="" className="text-base dark:text-white font-semibold leading-4 text-gray-800">Change Order Status</label>
                                                <select onChange={handleOrderStatusChange} name="" id="" className="text-sm dark:text-gray-300 leading-5 text-gray-600">
